...
mod test {
    ...
    use crate::data_structures::{
        PreprocessedCommitments, ProverKey, ProverPreprocessedInput,
    ...
    fn test_rescue_gate() {
        ...
        let (selector_commitments, rands) =
        ...
        let mut verifier_pp =
            preprocessed_commitments.to_verifier_preprocessed();
