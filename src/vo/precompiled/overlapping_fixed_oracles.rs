...
mod tests {
    ...
    fn test_overlapping_instance_oracles() {
        ...
        let fixed_oracles: &mut [&mut FixedProverOracle<F>] = &mut [&mut x];
        ...
        let mut fixed_oracles: &mut [&mut FixedVerifierOracle<F, PC>] = gate_1_fixed_oracles_v.iter_mut().into_slice();
