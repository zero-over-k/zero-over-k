...
// use crate::{vo::query::{Rotation, Sign}, commitment::HomomorphicCommitment};
...
// pub trait Instantiable<F: PrimeField>: ConcreteOracle {
//     fn query_at_rotated_root_of_extended_domain(&self, original_domain_size: usize, rotation: Rotation, omega_i: usize) -> F;
...
// pub trait Committed<F: PrimeField, PC: HomomorphicCommitment<F>> {

// }

// pub struct WitnessOracle<F: PrimeField> {
...
// impl<F: PrimeField> ConcreteOracle for WitnessOracle<F> {
//     fn register_rotation(&mut self, rotation: Rotation) {
...
// impl<F: PrimeField> Instantiable<F> for WitnessOracle<F> {
//     fn query_at_rotated_root_of_extended_domain(&self, original_domain_size: usize, rotation: Rotation, omega_i: usize) -> F {
...
// impl<F: PrimeField> ConcreteOracle for InstantiableConcreteOracle<F> {
//     fn register_rotation(&mut self, rotation: Rotation) {
//         self.queried_rotations.insert(rotation);
//     }
...
// impl<F: PrimeField, PC: HomomorphicCommitment<F>> ConcreteOracle for CommittedConcreteOracle<F, PC> {
//     fn register_rotation(&mut self, rotation: Rotation) {
//         self.queried_rotations.insert(rotation);
//     }
...
// // pub struct FixedConcreteOracle<F: PrimeField, PC: HomomorphicCommitment<F, PC> {
