...
impl<F: PrimeField, PC: HomomorphicCommitment<F>> ConcreteOracle<F> for FixedOracle<F, PC> {
...
impl<F: PrimeField, PC: HomomorphicCommitment<F>> Instantiable<F> for FixedOracle<F, PC> {
...
impl<F: PrimeField, PC: HomomorphicCommitment<F>> CommittedOracle<F, PC> for FixedOracle<F, PC> {
...
impl<F: PrimeField, PC: HomomorphicCommitment<F>> QuerySetProvider<F> for FixedOracle<F, PC> {
    fn get_query_set(
        &self,
